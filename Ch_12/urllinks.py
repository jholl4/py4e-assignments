...
# from the data files below, extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the 
...
# Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Linda.html
