...
# The program will use urllib to read the HTML from the data files below, and parse the data, extracting numbers and compute the sum of the numbers in the 
# file.
...
# Actual data: http://py4e-data.dr-chuck.net/comments_1861905.html (Sum ends with 40)
...
for tag in tags:
    try:
        contList.append(int(tag.contents[0]))
        count += 1
    except:
